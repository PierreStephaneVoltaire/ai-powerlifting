...
/**
 * Regenerate deterministic current-block analysis. Pass `windows` to regenerate
 * specific window keys (e.g. ['previous_4']); omit to regenerate all. AI
 * sections are regenerated by their own explicit Generate/Refresh actions.
 */

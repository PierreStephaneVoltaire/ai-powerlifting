...
_ROUTING = {
    "weight_add_entry": "weight_add_entry",
    "weight_get_log": "weight_get_log",
    "weight_log_add": "weight_log_add",
    "weight_log_get": "weight_log_get",
    "weight_log_remove": "weight_log_remove",
    "weight_remove_entry": "weight_remove_entry",
}
...
def handler(event, context):
    ...
    logger.info("[pod_weight] dispatching function=%s", fn_name)
    try:
        ...
        logger.exception("[pod_weight] error in function=%s", fn_name)

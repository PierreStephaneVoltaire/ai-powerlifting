...
_ROUTING = {
    ...
    "budget_create_item": "budget_create_item",
    "budget_delete_item": "budget_delete_item",
    "budget_get_config": "budget_get_config",
    "budget_get_summary": "budget_get_summary",
    "budget_list_items": "budget_list_items",
    "budget_priority_timeline": "budget_priority_timeline",
    "budget_put_config": "budget_put_config",
...
def handler(event, context):
    ...
    logger.info("[pod_budget] dispatching function=%s", fn_name)
    try:
        ...
        logger.exception("[pod_budget] error in function=%s", fn_name)

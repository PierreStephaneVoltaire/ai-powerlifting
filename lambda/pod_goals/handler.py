...
_ROUTING = {
    ...
    "goals_replace": "goals_replace",
    "health_get_goals": "health_get_goals",
    "health_update_goals": "health_update_goals",
}
...
def handler(event, context):
    ...
    logger.info("[pod_goals] dispatching function=%s", fn_name)
    try:
        ...
        logger.exception("[pod_goals] error in function=%s", fn_name)

...
def _get_table():
    """Lazily create and return the DynamoDB table resource for the health table."""
    global _table
    if _table is None:
...
async def weight_get_log(args: dict) -> dict:
    """Get the weight log for a program version.

...
_ROUTING = {
    ...
    "ipf_weight_classes": "ipf_weight_classes",
    "calculate_dots": "calculate_dots",
    "estimate_1rm": "estimate_1rm",
...
def handler(event, context):
    ...
    logger.info("[pod_calc] dispatching function=%s", fn_name)
    try:
        ...
        logger.exception("[pod_calc] error in function=%s", fn_name)

...
_ROUTING = {
    "health_get_current_maxes": "health_get_current_maxes",
    "health_update_current_maxes": "health_update_current_maxes",
    "max_history_add": "max_history_add",
    "max_history_get": "max_history_get",
    "max_target_get": "max_target_get",
    "max_target_update": "max_target_update",
}
...
def handler(event, context):
    ...
    logger.info("[pod_maxes] dispatching function=%s", fn_name)
    try:
        ...
        logger.exception("[pod_maxes] error in function=%s", fn_name)

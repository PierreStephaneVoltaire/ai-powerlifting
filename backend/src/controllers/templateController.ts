...
export async function listTemplates(req: Request, res: Response) {
  ...
  try {
    const data = await invokeLambda('template_list', { include_archived, ...templateActor(req) })
    res.json(data)
  } catch (err: any) {
...
export async function getTemplate(req: Request, res: Response) {
  ...
  try {
    const data = await invokeLambda('template_get', { sk, ...templateActor(req) })
    res.json(data)
  } catch (err: any) {
...
export async function createTemplateFromBlock(req: Request, res: Response) {
  ...
  try {
    const result = await invokeLambda('template_create_from_block', { name, program_sk, ...templateActor(req), pk: req.mapped_pk })
...
export async function createBlankTemplate(req: Request, res: Response) {
  ...
  try {
    const result = await invokeLambda('template_create_blank', {
      name,
...
export async function updateTemplate(req: Request, res: Response) {
  ...
  try {
    const result = await invokeLambda('template_update', { sk, template, ...templateActor(req), pk: req.mapped_pk })
    res.json(result)
  } catch (err: any) {
    if (err.message?.includes('not found')) throw new AppError('Template not found', 404)
...
export async function copyTemplate(req: Request, res: Response) {
  ...
  try {
    const result = await invokeLambda('template_copy', { sk, new_name, ...templateActor(req), pk: req.mapped_pk })
    res.status(201).json(result)
  } catch (err: any) {
...
export async function archiveTemplate(req: Request, res: Response) {
  const sk = normalizeTemplateSk(req.params.sk)
  try {
    const result = await invokeLambda('template_archive', { sk, ...templateActor(req), pk: req.mapped_pk })
    res.json(result)
  } catch (err: any) {
...
export async function unarchiveTemplate(req: Request, res: Response) {
  const sk = normalizeTemplateSk(req.params.sk)
  try {
    const result = await invokeLambda('template_unarchive', { sk, ...templateActor(req), pk: req.mapped_pk })
    res.json(result)
  } catch (err: any) {
...
export async function applyTemplate(req: Request, res: Response) {
  ...
  try {
    const result = await invokeLambda('template_apply', { sk, target, start_date, week_start_day, ...templateActor(req), pk: req.mapped_pk })
    res.json(result)
  } catch (err: any) {
...
export async function confirmApplyTemplate(req: Request, res: Response) {
  ...
  try {
    const result = await invokeLambda('template_apply_confirm', {
      sk,
      backfilled_maxes,
      start_date,
      week_start_day,
...
export async function publishTemplate(req: Request, res: Response) {
  const sk = normalizeTemplateSk(req.params.sk)
  try {
    const result = await invokeLambda('template_publish', { sk, ...templateActor(req), pk: req.mapped_pk })
    res.json(result)
  } catch (err: any) {
...
export async function unpublishTemplate(req: Request, res: Response) {
  const sk = normalizeTemplateSk(req.params.sk)
  try {
    const result = await invokeLambda('template_unpublish', { sk, ...templateActor(req), pk: req.mapped_pk })
    res.json(result)
  } catch (err: any) {
